						...
						<BrowserRouter basename={process.env.PUBLIC_URL}>
							<Switch>
								<Route
									...
									render={() => <PersonalityQuestionnaire {...this.state} />}
								/>
								<Route
									path="/user/cquestionnaire"
									render={() => <CodingQuestionnaire {...this.state} />}
								/>
								<Route
									render={() =>
