...
class PersonalityQuestionnaire extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            location:"",
            attrgender:this.props.location.state.attrgender,
            pa1:this.props.location.state.pa1,
            pa2:this.props.location.state.pa2,
            pa3:this.props.location.state.pa3,
            pa4:this.props.location.state.pa4,
            pa5:this.props.location.state.pa5,
            pa6:this.props.location.state.pa6,
            pa7:this.props.location.state.pa7,
            pa8:this.props.location.state.pa8,
            pa9:this.props.location.state.pa9,
            pa10:this.props.location.state.pa10,
            pa11:this.props.location.state.pa11,
            pa12:this.props.location.state.pa12,
            pa13:this.props.location.state.pa13,
            pa14:this.props.location.state.pa14,
            pa15:this.props.location.state.pa15,
            pa16:this.props.location.state.pa16,
            pa17:this.props.location.state.pa17,
            description:""
        }
