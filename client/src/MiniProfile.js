...
class MiniProfile extends Component {
	componentDidMount() {
		let div = document.getElementById(
			this.props.userData.user + '-match-percent'
		)
		let color = (this.props.match_percent / 100) * 120 + 200
		...
		return (
			<div className="MiniProfileWidget">
				<div className="row">
					...
					<div className="col-md-9">
						<div className="row">
							...
							<div
								id={this.props.userData.user + '-match-percent'}
								className="compatibilityDiv col-md-1"
							>
				...
				<div className="row extra-row-imgs">
					<div className="col-md-4 profSect">
						<ProfileImage1 uData={this.props.userData} />
					</div>
					<div className="col-md-4 profSect">
						<ProfileImage2 uData={this.props.userData} />
					</div>
					<div className="col-md-4 profSect">
						<ProfileImage3 uData={this.props.userData} />
					</div>
				</div>
